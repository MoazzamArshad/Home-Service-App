...
fun ProviderDetailsScreen(
    ...
    if (showRejectDialog) {
        AlertDialog(
            ...
            title = { Text("Reject Provider", fontWeight = FontWeight.Bold, color = Color(0xFF111827)) },
            text = { Text("Are you sure you want to reject this provider application?", color = Color(0xFF4B5563)) },
            confirmButton = {
                TextButton(onClick = {
                    ...
                    Text("Reject", color = Color(0xFFDC2626), fontWeight = FontWeight.Bold)
                }
            },
            dismissButton = {
    ...
    if (previewDocName != null) {
        AlertDialog(
            ...
            containerColor = Color.White,
            shape = RoundedCornerShape(24.dp),
            title = { Text("ID Card Preview", fontWeight = FontWeight.Bold, color = Color(0xFF111827)) },
            text = {
                Column {
                    Text("Image File Name:", fontWeight = FontWeight.SemiBold, fontSize = 14.sp, color = Color(0xFF374151))
