        ...
        Column(
            ...
            if (showCancelDialog) {
                AlertDialog(
                    ...
                    text = { Text("Are you sure you want to cancel this booking? This action cannot be undone.", color = Color(0xFF4B5563)) },
                    confirmButton = {
                        TextButton(
                            onClick = {
                            ...
                            Text("Yes, Cancel", color = Color(0xFFDC2626), fontWeight = FontWeight.Bold)
                        }
                    },
                    dismissButton = {
                        TextButton(onClick = { showCancelDialog = false }) {
                            Text("No, Keep", color = Color(0xFF374151))
                        }
                    },
            ...
            if (booking.status.lowercase() != "cancelled" && booking.status.lowercase() != "completed") {
                Button(
