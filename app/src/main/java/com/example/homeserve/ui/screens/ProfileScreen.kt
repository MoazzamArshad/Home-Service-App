...
fun ProfileScreen(
    ...
    if (showSwitchDialog) {
        AlertDialog(
            ...
            text = {
                Text(
                    "Are you sure you want to switch to Provider mode? You will be able to manage jobs and earn money.",
    ...
    if (showDeleteDialog) {
        AlertDialog(
            ...
            text = {
                Column {
                    Text(
                        "Are you absolutely sure you want to delete your account? This action is permanent and cannot be undone.\n\nAll your bookings, addresses, messages, and notifications will be permanently deleted from our database.",
                        color = Color(0xFF6B7280),
                        fontSize = 14.sp,
                        lineHeight = 20.sp
                    )
    ...
    Column(
        ...
        Column(
            ...
            ProfileMenuItem(
                ...
                title = "Earn by becoming a provider",
